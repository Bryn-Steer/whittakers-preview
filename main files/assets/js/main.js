...
// Function to initialise Swiper sliders
function initializeSlider(
    ...
    const swiperOptions = {
        ...
        slidesPerView: 1,
        effect: "fade",
        speed: autoplay ? 4000 : 0,
        allowTouchMove: allowTouchMove,
    };

    // Only add autoplay when enabled
    if (autoplay) {
    ...
    // Only add navigation when enabled
    if (showNavigation && nextBtnClass && prevBtnClass) {
    ...
    // Only add pagination when enabled
    if (showPagination && paginationClass) {
    ...
    const sliderInit = new Swiper(sliderClass, swiperOptions);

    function animatedSwiper(selector, swiperInstance) {
        ...
        // Run animations once when the page loads
        runAnimations();

        // Only repeat animations when the slider is allowed to move
    ...
    animatedSwiper(sliderClass, sliderInit);
}

// Regular moving banner slider
initializeSlider(
    ".banner-slider",
    ".arrow-next",
    ".arrow-prev",
...
// Regular moving banner 2 slider
initializeSlider(
    ".banner2-slider",
    ".arrow-next2",
    ".arrow-prev2",
...
// Static Whittaker's hero banner
initializeSlider(
    ".banner3-slider",
    null,
    null,
